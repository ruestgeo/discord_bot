...
module.exports = {
    ...
    manual: "**--channel-dump**  ->  *number_of_messages*  ( *channel_id* **/** *channel_name* **/** __*message_link*__ )\n" +
...
/** @param {Globals} globals   @param {Discord.Message} msg   @param {String} content   @returns {String|void} */
    func: async function (globals, msg, content){ 
        ...
        let amount = parseInt( content.substring(0, content.indexOf(' ')).trim() );
        let target = content.substring(content.indexOf(' ')+1).trim();
