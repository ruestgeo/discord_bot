...
module.exports = {
    ...
    manual: "**--give-role-conditioned3**  ->  `{\"give-role\": [\"roleName\", ...] <, \"target\": \"roleName\"> <,  \"missing-role\": [[\"group1role\", ...], [\"group2role\", ...], ...]> }` \n" +
    ...
    func: async function (globals, msg, content){
        ...
        for (var _member of list){
            ...
            if(args.hasOwnProperty("missing-role")){
                var skip = true;
                for (var rolegroup of args["missing-role"]){
                    var missingRoleGroup = true;
                    for (var role of rolegroup){ //check if member missing all of at least one role group
