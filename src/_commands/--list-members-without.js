...
module.exports = {
    ...
    manual: "--list-members-without  ->  \\*none\\* ~~  or  ~~ \\*roleName\\* ~~  or  ~~ \\*roleID\\*  < ,  ... additional_roles_for_filtering>"+
            ".     *reply with an ordered list of members that do not have the specified roles (separated by commas)*\n"+
