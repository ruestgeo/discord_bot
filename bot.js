...
function commandHandler(msg, member, command, content, isRepeat){
    ...
    else if (command === '--ping'){  //unblocked and basic ping-pong
    ...
    .then(_ => {
        ...
        var reply5 = "" +
            ...
            utils.sleep(sleepTime*1000).then(_ => { 
                ...
                .then(_ => { msg.react('✅'); })
                .catch(err => {msg.channel.send(err + ". my status should be 'idle'.")})
    ...
    .catch(err => {msg.channel.send(err + ". My status should be 'busy' or 'DND'.")});
}
